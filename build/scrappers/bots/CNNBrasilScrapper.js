...
var CNNBrasilScrapper = /** @class */ (function (_super) {
    __extends(CNNBrasilScrapper, _super);
    function CNNBrasilScrapper() {
        return _super.call(this, { ID: "CNNBrasil", name: "CNN Brasil", url: "https://www.cnnbrasil.com.br/tudo-sobre/economia/", is_api: false }) || this;
    }
    CNNBrasilScrapper.prototype.parseHTMLData = function (document) {
        return __awaiter(this, void 0, void 0, function () {
            var news_list, NEWS, scrappedResults, index, news, link_element, link, img_element, img, description, content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        news_list = document.querySelector("main > div > div > ul");
                        if (!news_list)
                            throw new Error("Error while parsing HTML data from ".concat(this.name, ": News list not found"));
                        NEWS = news_list.querySelectorAll("li");
                        if (!NEWS)
                    ...
                    case 1:
                        ...
                        description = img_element === null || img_element === void 0 ? void 0 : img_element.getAttribute("title");
                        if (!description) {
                    ...
                    case 4:
                        index++;
                        return [3 /*break*/, 1];
                    case 5: return [2 /*return*/, Promise.resolve(scrappedResults)];
                }
            });
        });
    };
    CNNBrasilScrapper.prototype.getNewsContent = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var document, content, paragraphs, content_text, index, paragraph;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return CNNBrasilScrapper;
}(Scrapper_1.default));
exports.default = CNNBrasilScrapper;
