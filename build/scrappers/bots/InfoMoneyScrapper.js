...
var InfoMoneyScrapper = /** @class */ (function (_super) {
    __extends(InfoMoneyScrapper, _super);
    function InfoMoneyScrapper() {
        return _super.call(this, { ID: "InfoMoney", name: "InfoMoney", url: "https://www.infomoney.com.br/economia/", is_api: false }) || this;
    }
    InfoMoneyScrapper.prototype.parseHTMLData = function (document) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        news_list = (_a = document.querySelector("body > div:nth-of-type(4) > div")) === null || _a === void 0 ? void 0 : _a.querySelectorAll("article");
                        if (!news_list)
    ...
    InfoMoneyScrapper.prototype.getNewsContent = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        content = document.querySelector(".single__content");
                        if (!content)
                            return [2 /*return*/, null];
    ...
    return InfoMoneyScrapper;
}(Scrapper_1.default));
exports.default = InfoMoneyScrapper;
