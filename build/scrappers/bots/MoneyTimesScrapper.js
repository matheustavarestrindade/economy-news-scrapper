...
var MoneyTimesScrapper = /** @class */ (function (_super) {
    __extends(MoneyTimesScrapper, _super);
    function MoneyTimesScrapper() {
        return _super.call(this, { ID: "MoneyTimes", name: "MoneyTimes", url: "https://www.moneytimes.com.br/tag/economia/", is_api: false }) || this;
    }
    MoneyTimesScrapper.prototype.parseHTMLData = function (document) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var news_list, scrappedResults, index, news, link_element, link, description, img_element, img, content;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        news_list = (_a = document.querySelector(".news-list")) === null || _a === void 0 ? void 0 : _a.querySelectorAll(":scope > div");
                        if (!news_list)
                    ...
                    case 1:
                        ...
                        if (news.classList.contains("news-item--ad"))
                            return [3 /*break*/, 4];
                        ...
                        description = (_b = news === null || news === void 0 ? void 0 : news.querySelector("h2")) === null || _b === void 0 ? void 0 : _b.textContent;
                        if (!description) {
    ...
    MoneyTimesScrapper.prototype.getNewsContent = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var document, content, paragraphs, text_content, index, paragraph, text;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        content = document.querySelector(".single__text");
                        if (!content) {
                        ...
                        for (index = 0; index < paragraphs.length; index++) {
                            ...
                            if (!text)
                                continue;
                            if (text.includes("Siga o Money Times no Instagram!"))
                                break;
                            text_content.push(this.cleanupText(text));
                        }
                        return [2 /*return*/, text_content.join("\n")];
                }
            });
        });
    };
    return MoneyTimesScrapper;
}(Scrapper_1.default));
exports.default = MoneyTimesScrapper;
